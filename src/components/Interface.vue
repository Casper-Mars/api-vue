        ...
        <el-container>
            ...
            <el-main>
                ...
                <el-row>
                    ...
                    <el-row>
                        <!--请求参数示例-->
                        <JsonTestPenal v-if="interface.param.isJson" msg="请求参数示例" :jsonData="interface.param.jsonData"></JsonTestPenal>
                        <!--请求参数列表-->
                ...
                <el-row>
                    ...
                    <!--响应参数示例-->
                    <JsonTestPenal msg="响应参数示例" :json-data="interface.resp.jsonData"/>
                </el-row>
            </el-main>
        </el-container>
    </div>
...
<script>
    ...
    export default {
        ...
        // data() {
        //     return {
        //         interface:this.$store.getters.interface
        //     }
        // }
    }
</script>
